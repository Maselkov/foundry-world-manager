...
parser = argparse.ArgumentParser(
    description=
    "Jegasus' World Manager - Tool that can be used to compress FoundryVTT worlds."
)
parser.add_argument(
    '-u',
    '--user-data-folder',
...
parser.add_argument(
    ...
    metavar='',
    help=
    r'Foundry World folder. Ex: "worlds\kobold-cauldron", "worlds\porvenir"',
    default="")
parser.add_argument(
    '-c',
    '--core-data-folder',
...
parser.add_argument(
    ...
    metavar='',
    help=
    f'Location of the FFMPEG application/executable. Ex: "{default_ffmpeg_location}"',
